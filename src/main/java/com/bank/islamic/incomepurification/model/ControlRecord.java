package com.bank.islamic.incomepurification.model;
...
/**
 * The BIAN control record for this service domain: "Purification Entry Procedure".
 *
 ...
 * to its asset type (Purification Entry). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Purification Entry Procedure";
